...
@section('content')
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-end">
                ...
                {{-- <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('customer.setting')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <form action="{{env('APP_MODE')!='demo'?route('customer.settings'):'javascript:'}}" method="post" enctype="multipart/form-data" id="customer-settings-form">
                @csrf
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer" class="avatar-img"
                                 src="{{!empty(auth('customer')->user()->image) ? asset('storage/app/public/customer/'.auth('customer')->user()->image) : auth('customer')->user()?->imageFullPath}} "
                                 alt="Image">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        ...
                                        <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                               ...
                                               value="{{auth('customer')->user()->l_name}}">
                                    </div>
                                </div>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <form id="changePasswordForm" action="{{route('customer.settings-password')}}" method="post"
...
@push('script_2')
    <script src="{{ asset('public/assets/customer/js/settings.js') }}"></script>
    <script>
        $('#saveChangesButton').click(function() {
            if ('{{ env('APP_MODE') }}' === 'demo') {
                call_demo();
            } else {
                form_alert('customer-settings-form', '{{ translate("Want to update the information ?") }}');
            }
        });
