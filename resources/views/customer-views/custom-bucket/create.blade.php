...
@section('title', translate('Add Custom Bucket'))
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between gap-2 align-items-center mb-2">
                    <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                        <span class="page-header-title">{{ translate('Add New Custom Bucket') }}</span>
                    </h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="product[0][qty]" class="form-control" min="1" >
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        let rowIndex = 1; // Start index for dynamic fields
