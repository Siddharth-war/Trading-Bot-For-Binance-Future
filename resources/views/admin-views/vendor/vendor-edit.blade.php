                ...
                <form id="groupForm" action="{{ route('admin.vendor.savevendor') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-2 col-12">
                            ...
                            <input type="text" class="form-control " value="{{ $vendor?->first_name}}" name="first_name" id="signinSrEmail"
                        ...
                        <div class="mb-2 col-12">
                            <input type="text" class="form-control " value="{{ $vendor?->last_name}}" name="last_name" id="signinSrEmail"
                        ...
                        <div class="mb-2 col-12">
                            <input type="email" class="form-control " value="{{ $vendor?->email}}" name="email" id="signinSrEmail"
                         ...
                         <div class="mb-2 col-12">
                            <div class="input-group input-group-merge">
                                 <input type="text" class="js-toggle-password form-control form-control-lg"
                                     value="{{ $vendor?->phone_number}}" name="phone" id="signupSrPassword" maxlength="10"
