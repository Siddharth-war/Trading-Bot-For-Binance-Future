    ...
    <script>
        ...
        $(document).ready(function(){
            function updateCreditLimit() {
                let creditLimit = $("select[name='customer_id']").find(":selected").attr("data-id");
                let remain = $("select[name='customer_id']").find(":selected").attr("data-remain");

                if(creditLimit != remain){
                    creditLimit = remain;
                }else{
            ...
            updateCreditLimit();
            $("select[name='customer_id']").change(updateCreditLimit());

            function findCredit_mit(){
                let credit = credit_limit;
