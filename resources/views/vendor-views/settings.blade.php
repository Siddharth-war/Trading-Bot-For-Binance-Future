...
@section('content')
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-end">
                ...
                {{-- <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('vendor.setting')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <form action="{{env('APP_MODE')!='demo'?route('vendor.settings'):'javascript:'}}" method="post" enctype="multipart/form-data" id="vendor-settings-form">
                @csrf
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer" class="avatar-img"
                                 src="{{!empty(auth('vendor_users')->user()->image) ? asset('storage/app/public/vendor/'.auth('vendor_users')->user()->image) : auth('vendor_users')->user()?->imageFullPath}} "
                                 alt="Image">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="f_name" id="firstNameLabel"
                                               ...
                                               value="{{auth('vendor_users')->user()->first_name}}">
                                        <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                               ...
                                               value="{{auth('vendor_users')->user()->last_name}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           ...
                                           value="{{auth('vendor_users')->user()->phone_number}}"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           value="{{auth('vendor_users')->user()->email}}"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <form id="changePasswordForm" action="{{route('vendor.settings-password')}}" method="post"
...
@push('script_2')
    <script src="{{ asset('public/assets/vendor/js/settings.js') }}"></script>
    <script>
        $('#saveChangesButton').click(function() {
            if ('{{ env('APP_MODE') }}' === 'demo') {
                call_demo();
            } else {
                form_alert('vendor-settings-form', '{{ translate("Want to update the information ?") }}');
            }
        });
