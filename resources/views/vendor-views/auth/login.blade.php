...
<html lang="en">
    <head>
        ...
        <title>{{translate('Vendor')}} | {{translate('Login')}}</title>
    ...
    <div class="login-container">
        <div class="left-side d-flex justify-content-center align-items-center">
            <div class="login-box">
                ...
                <form  action="{{ route('vendor.auth.submit') }}" method="post">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="right-side">
            <div class="text-center text-primary">
                ...
                <a class="btn btn-primary" href="{{ route('vendor.auth.signup') }}">Sign Up</a>
